...
<section id="pricing" class="overflow-x-clip pt-2">
	<div class="mx-auto px-4 sm:px-12 xl:max-w-5xl xl:px-0">
		<div class="relative z-10 text-center md:mx-auto md:w-5/6 lg:w-4/6">
			<h2 class="text-3xl font-bold text-gray-900 dark:text-white md:text-4xl xl:text-5xl">Pricing & Plans</h2>
		</div>
		<div class="relative mt-20">

			<script async src="https://js.stripe.com/v3/pricing-table.js"></script>
			<stripe-pricing-table pricing-table-id="prctbl_1QDS6yP47aDWGh8AeDv6CptN"
														publishable-key="pk_test_51QDQpDP47aDWGh8AGxkdu0iIecCfbDqnKZYprTEe9wTg7ZSJIWepRvX9rgoFs1WvcI1aVq1fGw7ZC5ZR49a0NrBX006vot8Wvi">
