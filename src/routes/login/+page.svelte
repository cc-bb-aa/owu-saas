...
<div class="p-5 flex flex-col items-center h-full w-full pt-32 sm:pt-40 md:pt-28">
 ...
 {#if data.isAuthenticated}
  <button class="btn variant-filled-secondary btn-primary w-full" on:click={logout}>Logout</button>
 {:else}
  <p class="text-center mt-1">or <a href="/register" class="text-primary font-medium hover:cursor-pointer hover:underline yellow">Register</a> if you don't have an account</p>
