...
<div class="flex flex-col items-center h-full w-full pt-32 sm:pt-40 md:pt-28">
	...
	<p class="text-center mt-1">
		Or <a href="/login" class="text-primary font-medium hover:cursor-pointer hover:underline yellow"
			>login</a
	...
	<form action="?/register" method="POST" class="flex flex-col items-center space-y-2 w-full pt-4">
		...
		<div class="w-full max-w-lg pt-2">
			<button type="submit" class="btn variant-filled-secondary btn-primary w-full">register</button>
		</div>
			...
			<div class="alert alert-error shadow-lg w-full max-w-lg">
				<div>
					<svg
						...
						/></svg
					>
					<span>This name has already used!</span>
				</div>
			</div>
		{:else if form?.userEmailExist}
			<div class="alert alert-error shadow-lg w-full max-w-lg">
				<div>
					<svg
						xmlns="http://www.w3.org/2000/svg"
